...
function render(ast) {
  if (typeof ast === "number") {
    ...
    switch (ast.tag | 0) {
      ...
      case 14 : 
          var o$10 = ast[0];
          return Prettier.doc.builders.group(Curry._2(Prettier$LonaCompilerCore.Doc[/* Builders */0][/* <+> */5], Curry._2(Prettier$LonaCompilerCore.Doc[/* Builders */0][/* <+> */5], Curry._2(Prettier$LonaCompilerCore.Doc[/* Builders */0][/* <+> */5], Curry._2(Prettier$LonaCompilerCore.Doc[/* Builders */0][/* <+> */5], Curry._1(Prettier$LonaCompilerCore.Doc[/* Builders */0][/* s */0], "if"), Prettier.doc.builders.line), render(o$10.condition)), Prettier.doc.builders.line), render(/* CodeBlock */Block.__(23, [{
...
function renderInitializerBlock(node) {
  ...
  var renderStatements = function (statements) {
    if (statements) {
      if (statements[1]) {
        return render(/* CodeBlock */Block.__(23, [{
